...
public:
  ...
  GNodeB *CreateGnodeb(int id,
                       ...
                       BandwidthManager *bm);
    GNodeB *CreateSatGnodeb(bool isLeo, int id,
                       Cell *cell,
                       double pos_X, double pos_Y, double pos_Z,
                       int numTxAntennas, int numRxAntennas,
                       RadioChannel *dlCh, RadioChannel *ulCh,
                       BandwidthManager *bm, int NumSat);
  IABNode *CreateIABNode(int id,
                         Cell *cell,
                         double pos_X, double pos_Y,
                         int numTxAntennas, int numRxAntennas,
                         RadioChannel *dlCh, RadioChannel *ulCh,
                         BandwidthManager *bm);
  IABNode *CreateSatIABNode(bool isLeo, int id,
                            Cell *cell,
                            double pos_X, double pos_Y, double pos_Z,
                            int numTxAntennas, int numRxAntennas,
                            RadioChannel *dlCh, RadioChannel *ulCh,
...
UserEquipment* CreateSatUserEquipment (int id, double pos_X, double pos_Y, double speed, double speedDirection, int numTxAntennas, int numRxAntennas,
                                     Cell* cell, GNodeB* gnb);
  UserEquipment *CreateMobileTermination(int id,
                                         double pos_X, double pos_Y, double speed, double speedDirection, int numTxAntennas, int numRxAntennas,
                                         Cell *cell, GNodeB *gnb, IABNode *iab);
                                           UserEquipment *CreateSatMobileTermination(int id,
                                         double pos_X, double pos_Y, double speed, double speedDirection, int numTxAntennas, int numRxAntennas,
                                         Cell *cell, GNodeB *gnb, IABNode *iab);
