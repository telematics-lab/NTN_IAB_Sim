                                    ...
                                    int dlOffset, bool tddTrue)
{
  ...
  //By default the scenario is 5G, not NB-IoT
  m_NbIoTenabled = false;
...
BandwidthManager::BandwidthManager (double ulBw, double dlBw, int ulOffset,
                                    int dlOffset, bool tddTrue, double scs):BandwidthManager::BandwidthManager (ulBw, dlBw, ulOffset, dlOffset, tddTrue)
{
...
BandwidthManager::CreateNbIoTspectrum (int nbOfNbIoTcarriers, double spacing,
                                       int tones)
{
  //The choosen technology is NB-IoT:
  m_NbIoTenabled = true;
...
{
	return m_NbIoTenabled;
}

bool 
BandwidthManager::GetSatenabled() const 
{
  return m_Satenabled;
}
...
void 
BandwidthManager::EnableSatelliteScenario() 
{
  m_Satenabled = true;
}

void 
BandwidthManager::SetMCSindex(int mcs)
{
  m_MCSindex = mcs;
}

int 
BandwidthManager::GetMCSindex() const
{
  return m_MCSindex;
}
