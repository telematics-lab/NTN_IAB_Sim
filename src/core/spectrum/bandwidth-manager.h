...
public:
  ...
  BandwidthManager (double ulBw, double dlBw, int ulOffset, int dlOffset, bool tddTrue, double scs);
  ...
  bool GetSatenabled() const;
  void EnableSatelliteScenario();

  double GetSubcarrierSpacing() const;

  void SetMCSindex(int mcs);
  int GetMCSindex() const;
