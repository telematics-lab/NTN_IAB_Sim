...
public:
  struct UserEquipmentRecord
  {
    ...
    vector<int> m_uplinkChannelStatusIndicator;
    void SetUplinkChannelStatusIndicator (vector<int> vet);
    vector<int> GetUplinkChannelStatusIndicator (void) const;
  ...
  GNodeB (int idElement, Cell *cell, double posx, double posy, double posz, int nSat, bool isNBIoT);
  ...
  //Debug
  void Print (void);
  UserEquipmentRecords *m_userEquipmentRecords; //Made public for IABNode
private:
