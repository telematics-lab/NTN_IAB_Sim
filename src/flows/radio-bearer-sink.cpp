...
#include "application/relay-receiver.h"
...
*/
/*RadioBearerSink::RadioBearerSink(RelayReceiver* a)
{
  SetClassifierParameters (nullptr);
  SetSource (nullptr);
  SetDestination (nullptr);
...
void
RadioBearerSink::SetRelay (RelayReceiver* a)
{
  m_relay = a;
  m_application = nullptr;
}
