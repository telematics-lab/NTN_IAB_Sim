...
/*
  Description: inerithed from UC1DirectUl
*/

//Basic configuration: ./5G-air-simulator P_002_SENSOR_DATA_1 1 1 2 0 0 250 5 294.5 

static void P_002_SENSOR_DATA_1(int argc, char *argv[])
{
