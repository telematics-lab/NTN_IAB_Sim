...
/*
  Description: inerithed from UC2DirectUl
*/

//Basic configuration: ./5G-air-simulator P_003_BB_DATA_1 1 2 45 5000 0.005 10.0

static void P_003_BB_DATA_1(int argc, char *argv[])
{
