...
/*
  The following Scenario simulate the case in wich a GNodeB (ID = 6) try to periodically send packets
  through a CBR Application, being in the range of a Satellite IABNode MT (ID = 5) in charge to receive packets and relays
  them via a Satellite IABNode DU (ID = 4) to a terrestrial IABNode MT (ID = 3), in turn responsible of forwarding 
  the data via an IABNode DU (ID = 2) to a terrestrial UE (ID = 1000).
*/

//Basic configuration: ./5G-air-simulator UC1RelayDl 1 1 2 0 0 250 5 294.5 

static void UC1RelayDl(int argc, char *argv[])
{
