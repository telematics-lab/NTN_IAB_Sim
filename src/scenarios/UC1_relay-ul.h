...
#include <random>
 ...
 /*
  ...
  them via a MobileTermination (ID = 3) to a Satellite IAB Node (ID = 4), in charge to receive packets and relays
  them via a MobileTermination (ID = 5) to a terrestrial GNodeB (ID = 6).
*/

//Basic configuration: ./5G-air-simulator UC1RelayUl 1 1 2 0 0 250 5 294.5 

static void UC1RelayUl(int argc, char *argv[])
{
