...
/*
  Description: inherited from UC2RelayUl
*/

//Basic configuration: ./5G-air-simulator V_003_MULTI_UE 1 2 45 5 0.004 20.0

static void V_003_MULTI_UE(int argc, char *argv[])
{
