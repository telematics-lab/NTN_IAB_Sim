...
static void RelayExampleUl()
{
  ...
  */
  ...
  BandwidthManager *spectrum = new BandwidthManager(20, 20, spectrum_index*offset, spectrum_index*offset, false); // 20 MHz in Dl and Ul, true to abilitate TDD
  ...
  BandwidthManager *spectrum_relay = new BandwidthManager(20, 20, spectrum_index*offset, spectrum_index*offset, false); // 20 MHz in Dl and Ul, true to abilitate TDD
  ...
  int srcID = 1;      //It can be assumed the ID as a L3 address, i.e., the IP address
  int dstID = 4;      
