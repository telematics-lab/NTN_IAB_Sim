...
static void RelaySatExampleUl()
{
  ...
  */
  ...
  ue->GetPhy ()->SetCarrierFrequency(2000);
  ue->GetPhy ()->SetTxPower(23); //23
  ue->GetPhy ()->GetAntennaParameters ()->SetType(Phy::AntennaParameters::ANTENNA_TYPE_OMNIDIRECTIONAL);
